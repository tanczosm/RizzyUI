/**
 * Canonical Alpine component -> owning bundle manifest.
 *
 * Rules:
 * - Every JS-backed Alpine component belongs to exactly one bundle.
 * - Shell entrypoints remain thin and must not eagerly import these bundles.
 * - If a component no longer needs JS (e.g. RzEmpty), remove it from this manifest.
 */
