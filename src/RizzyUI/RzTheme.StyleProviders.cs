...
public partial class RzTheme
{
    ...
    /// <summary> Gets or sets the style definitions for the <see cref="RizzyUI.ConfettiTrigger"/> component. </summary>
    public virtual TvDescriptor<RzAsChildComponent<ConfettiTrigger.Slots>, ConfettiTrigger.Slots> ConfettiTrigger { get; set; }
