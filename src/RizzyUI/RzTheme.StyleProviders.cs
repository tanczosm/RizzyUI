...
public partial class RzTheme
{
    ...
    /// <summary> Gets or sets the style definitions for the <see cref="RizzyUI.RzOrbitingCircles"/> component. </summary>
    public virtual TvDescriptor<RzComponent<RzOrbitingCircles.Slots>, RzOrbitingCircles.Slots> RzOrbitingCircles { get; set; }
