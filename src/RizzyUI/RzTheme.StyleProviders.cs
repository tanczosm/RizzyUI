...
public partial class RzTheme
{
    ...
    /// <summary> Gets or sets the style definitions for the <see cref="RizzyUI.RzShimmerButton"/> component. </summary>
    public virtual TvDescriptor<RzComponent<RzShimmerButton.Slots>, RzShimmerButton.Slots> RzShimmerButton { get; set; }
