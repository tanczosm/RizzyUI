...
public partial class DialogContent : RzComponent<DialogContent.Slots>
{
    ...
    public static readonly TvDescriptor<RzComponent<Slots>, Slots> DefaultDescriptor = new(
        ...
        slots: new()
        {
            ...
            [s => s.CloseButton] = "data-[state=open]:bg-accent data-[state=open]:text-muted-foreground absolute top-4 right-4 rounded-xs opacity-70 transition-opacity hover:opacity-100 focus:ring-[3px] focus:ring-ring/50 focus:outline-hidden disabled:pointer-events-none",
