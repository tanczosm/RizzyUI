...
public partial class SheetContent : RzComponent<SheetContent.Slots>
{
    ...
    public static readonly TvDescriptor<RzComponent<Slots>, Slots> DefaultDescriptor = new(
        ...
        slots: new()
        {
            ...
            [s => s.CloseButton] = "ring-offset-background focus:ring-ring data-[state=open]:bg-secondary absolute top-4 right-4 rounded-sm opacity-70 transition-opacity hover:opacity-100 focus:ring-[3px] focus:ring-ring/50 focus:outline-none disabled:pointer-events-none",
