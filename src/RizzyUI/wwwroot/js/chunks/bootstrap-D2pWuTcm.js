...
var RzToastManager = class {
	...
	animateStackShift(stack, previousPositions, insertedElement, speed) {
		...
		getStackItems(stack).forEach((item) => {
			...
			window.setTimeout(() => {
				...
				if (item.style.transform?.startsWith("translate3d(0,")) item.style.transform = "";
			}, speed);
		});
	}
	...
	removeToast(toast, reason, animateRemoval = reason !== "clear") {
		...
		if (root && stack) {
			...
			if (previousStackPositions) this.animateStackShift(stack, previousStackPositions, null, toast.options.speed);
		}
...
var bundleLoaderRegistry = Object.freeze({
	...
	"advanced-input-runtime": () => __vitePreload(() => import("./advanced-input-runtime-DpOcyHzn.js"), [], import.meta.url),
	"calendar-runtime": () => __vitePreload(() => import("./calendar-runtime-cjykBVWx.js"), [], import.meta.url),
	"table-runtime": () => __vitePreload(() => import("./table-runtime-D4QHNZ-a.js"), [], import.meta.url),
	"color-runtime": () => __vitePreload(() => import("./color-runtime-Cvgwv9TS.js"), [], import.meta.url),
	"content-visual-runtime": () => __vitePreload(() => import("./content-visual-runtime-CNjJACil.js"), [], import.meta.url),
	...
	"docs-runtime": () => __vitePreload(() => import("./docs-runtime-BrGOZHCd.js"), [], import.meta.url),
	"effects-runtime": () => __vitePreload(() => import("./effects-runtime-BF0ec1-j.js"), [], import.meta.url)
});
//#endregion
...
//# sourceMappingURL=bootstrap-D2pWuTcm.js.map