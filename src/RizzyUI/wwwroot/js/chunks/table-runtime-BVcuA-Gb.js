import { f as flex } from "./bootstrap-D1hoDQyf.js";
/**
   * table-core
   *
...
function buildPaginationItems(pageIndex, pageCount) {
  ...
  const includedPages = /* @__PURE__ */ new Set([
    0,
    1,
    pageCount - 2,
    pageCount - 1,
  ...
  const normalizedPages = [...includedPages].filter((x) => x >= 0 && x < pageCount).sort((a, b) => a - b);
  const items = [];
...
//# sourceMappingURL=table-runtime-BVcuA-Gb.js.map
