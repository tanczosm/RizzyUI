import { b as bootstrapRizzyUI } from "./chunks/bootstrap-B_lodrSV.js";
...
const RizzyUI = bootstrapRizzyUI(module_default);
RizzyUI.ready.then(() => {
  module_default.start();
}).catch((error2) => {
  console.error("[RizzyUI] Failed to initialize CSP runtime.", error2);
});
