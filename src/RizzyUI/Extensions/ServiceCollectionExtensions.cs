...
public static class ServiceCollectionExtensions
{
    ...
    private static IServiceCollection AddRizzyUIInternal(this IServiceCollection services)
    {
        ...
        services.PostConfigure<RizzyUIConfig>(config =>
        {
            ...
            config.AssetUrls.TryAdd("Coloris", "https://cdn.jsdelivr.net/npm/@melloware/coloris/dist/coloris.min.js");
            config.AssetUrls.TryAdd("ColorisCss", "https://cdn.jsdelivr.net/npm/@melloware/coloris/dist/coloris.min.css");
